/**
 * POST /api/runs/[runId]/controls — upload the controls CSV artifact for a run.
 * Expects a multipart/form-data body with a 'file' field containing the CSV.
 */
...
/** Stores the controls CSV and returns { ok: true }, or 404/500 on failure. */
